...
const About = () => {
    return (
        <>
            ...
            <div className="w-full p-6 my-10 font-sans text-text flex flex-col lg:flex-row gap-6">

                <div className="w-[280px] flex flex-col gap-4 mx-6">
                ...
                <div className="w-4/5">
                    <h1 className="text-primary font-bold text-[28px] mb-4">Giới thiệu</h1>

                    <div className="text-[16px] leading-[2.4]">
                        <p>
                            Cay - không chỉ là vị, mà là trải nghiệm.
                            Bước chân vào Omega Noodles, bạn sẽ lập tức cảm nhận được sự khác biệt. Không gian bên trong cuốn hút với thiết kế hiện đại, trẻ trung nhưng vẫn ấm cúng.
                        </p>
                        <p>
                            Cay ở đây không đơn thuần chỉ là vị. Cay là trải nghiệm.
                            Bảng thực đơn với 7 cấp độ cay sẽ thử thách bạn, xem bạn chinh phục được đến đâu.
                        </p>
                        <p>
                            Ngay từ cấp 1 - bạn đã cảm nhận được sự khác biệt.
                            Nước lèo đậm vị, hương thơm đặc trưng của ớt tạo nên “cú nổ” vị giác ngay từ lần đầu.
                        </p>
                        <p>
                            Nếu đủ “dạn dày” để chinh phục cấp cao nhất của Omega – trải nghiệm sẽ mãnh liệt gấp bội.
                            Hương vị cay xé nồng kích thích giác quan, khiến bạn vừa muốn dừng lại, vừa không thể ngừng ăn.
                        </p>
                        <p>
                            Nhưng Omega Noodles không chỉ có cay.
                            Món ăn được đầu tư chất lượng: nguyên liệu tươi ngon, chế biến tinh tế, sợi mì dai giòn, nước lèo đậm đà.
                        </p>
                        <p>
                            Dịch vụ là điểm nhấn khác biệt. Nhân viên sẽ trở thành “người cố vấn”
                            đồng hành cùng bạn chinh phục từng cấp độ cay một cách trọn vẹn.
                        </p>
                        <p>
                            Omega Noodles là hành trình trải nghiệm đáng nhớ xoay quanh cay – vị của thách thức và khám phá!
                        </p>
                    </div>
                </div>
            </div>
