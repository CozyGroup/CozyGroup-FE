    ...
    return (
        <>
            ...
            <div className="w-full p-[30px] my-10 font-quicksand text-text flex flex-col lg:flex-row gap-6 align-center justify-center">
                <div className="max-w-6xl w-full flex flex-col lg:flex-row bg-white shadow-lg overflow-hidden">
                    {/* Bên trái */}
                    <div className="bg-primary text-white flex flex-col justify-center items-center py-6 lg:w-1/3">
                        <div className="border-dashed border-white border p-10 text-center md:p-52 lg:p-10">
